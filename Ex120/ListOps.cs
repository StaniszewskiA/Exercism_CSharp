...
public static class ListOps
{
    ...
    public static int Length<T>(List<T> input) => Foldl(input, 0, (count, o) => count + 1);

    public static List<T> Reverse<T>(List<T> input) => Foldl(input, new List<T>(), (state, o) => Cons(o, state));
